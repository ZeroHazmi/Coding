        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descendants = table.Column<string>(type: "text", nullable: false),
                    Religion = table.Column<string>(type: "text", nullable: false),
                    HousePhoneNumber = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateStructure = table.Column<string>(type: "json", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldValue = table.Column<string>(type: "json", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportDetail_ReportTypes_ReportTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportTypeId = table.Column<int>(type: "integer", nullable: false),
                    ReportDetailId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reports_ReportDetail_ReportDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportDetail_ReportTypeId",
                table: "ReportDetail",
                column: "ReportTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_ReportDetailId",
                table: "Reports",
